...
###1) Code is properly seperated based upon Knockout's best practices (following MVVM pattern, avoiding updating the DOM manually, using observables rather than forcing refreshes manually, etc).
